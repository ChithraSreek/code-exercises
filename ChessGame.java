...
public class ChessGame {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedImage all = ImageIO.read(new File("~/Documents/CodeWars/src/main/java/chess/chess.png"));
        ...
        frame.addMouseListener(new MouseListener() {
            ...
            @Override public void mousePressed(MouseEvent e) {
                System.out.println((Objects.requireNonNull(getPiece(e.getX(), e.getY())).isWhite? "white" : "black") +
                        Objects.requireNonNull(getPiece(e.getX(), e.getY())).name);
